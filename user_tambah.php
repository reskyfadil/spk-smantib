    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <?php
                $kode_user = kode_oto('kode_user', 'tb_user', 'U', 3);
                if ($kode_user !== null) {
                    $kode_user_value = $kode_user;
                } else {
                    $kode_user_value = '';
                }
                ?>
                <input class="form-control" type="text" name="kode_user" value="<?= set_value('kode_user', $kode_user_value) ?>" />
            </div>
            <div class="form-group">
