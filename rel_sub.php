...
<div class="panel panel-default">
                ...
                <form class="form-inline" action="?m=rel_sub&kode_kriteria=<?= isset($_GET['kode_kriteria']) ? $_GET['kode_kriteria'] : '' ?>" method="post">
                    <div class="form-group">
                        <select class="form-control" name="ID1">
                            <?= get_sub_option(isset($_GET['kode_kriteria']) ? $_GET['kode_kriteria'] : '', $_POST['ID1']) ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="ID2">
                            <?= get_sub_option(isset($_GET['kode_kriteria']) ? $_GET['kode_kriteria'] : '', $_POST['ID2']) ?>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php
                $lambda_max = lambda_max($total, $rata);
                $n = count($rata);
                $CI = ($lambda_max - $n) / ($n - 1);
                $RI = $nRI[count($matriks)];
                $CR = $RI == 0 ? 0 : $CI / $RI;
                echo "<p>Lambda Max: " . round(($lambda_max), 3) . "<br />";
