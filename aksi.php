...
elseif ($mod == 'alternatif_tambah') {
...
} elseif ($mod == 'alternatif_tambah_excel') {
    if (isset($_FILES['excel_file']) && $_FILES['excel_file']['error'] == UPLOAD_ERR_OK) {
        ...
        if (file_exists($inputFileName)) {
            ...
            foreach ($rowIterator as $row) {
                ...
                list($kode, $nama) = $data;
                if ($kode && $nama) {
                    if (!$db->get_results("SELECT * FROM tb_alternatif WHERE kode_alternatif='$kode'")) {
                        $db->query("INSERT INTO tb_alternatif (kode_alternatif, nama_alternatif) VALUES ('$kode', '$nama')");
    ...
    elseif ($act == 'alternatif_ubah') {
        ...
        //     print_msg("NIM sudah ada!");
            ...
            $db->query("UPDATE tb_alternatif SET kode_alternatif='$kode', nama_alternatif='$nama' WHERE kode_alternatif='$kode'");
