    ...
    <div class="col-sm-5">
        ...
        <div class="ant-row ant-form-item">
                  ...
                  <div class="ant-form-item-control has-success">
                    <span class="ant-form-item-children">
                      <span class="ant-input-password ant-input-password-large ant-input-affix-wrapper ant-input-affix-wrapper-lg">
                        <input type="password" placeholder="Masukkan Password Lama" id="inputPassword" class="ant-input ant-input-lg" name="pass1">
              ...
              <div class="ant-row ant-form-item">
                <div class="ant-col ant-form-item-control-wrapper">
                  <div class="ant-form-item-control has-success">
                    <span class="ant-form-item-children">
                      <span class="ant-input-password ant-input-password-large ant-input-affix-wrapper ant-input-affix-wrapper-lg">
                        <input type="password" placeholder="Masukkan Password Baru" id="inputPassword1" class="ant-input ant-input-lg" name="pass2">
                        <span class="ant-input-suffix">
                          <i aria-label="icon: eye-invisible" tabindex="-1" class="anticon anticon-eye-invisible ant-input-password-icon" id="togglePasswordVisibility1">
                            <svg viewBox="64 64 896 896" focusable="false" class="" data-icon="eye-invisible" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                              <path d="M942.2 486.2Q889.47 375.11 816.7 305l-50.88 50.88C807.31 395.53 843.45 447.4 874.7 512 791.5 684.2 673.4 766 512 766q-72.67 0-133.87-22.38L323 798.75Q408 838 512 838q288.3 0 430.2-300.3a60.29 60.29 0 0 0 0-51.5zm-63.57-320.64L836 122.88a8 8 0 0 0-11.32 0L715.31 232.2Q624.86 186 512 186q-288.3 0-430.2 300.3a60.3 60.3 0 0 0 0 51.5q56.69 119.4 136.5 191.41L112.48 835a8 8 0 0 0 0 11.31L155.17 889a8 8 0 0 0 11.31 0l712.15-712.12a8 8 0 0 0 0-11.32zM149.3 512C232.6 339.8 350.7 258 512 258c54.54 0 104.13 9.36 149.12 28.39l-70.3 70.3a176 176 0 0 0-238.13 238.13l-83.42 83.42C223.1 637.49 183.3 582.28 149.3 512zm246.7 0a112.11 112.11 0 0 1 146.2-106.69L401.31 546.2A112 112 0 0 1 396 512z"></path>
                              <path d="M508 624c-3.46 0-6.87-.16-10.25-.47l-52.82 52.82a176.09 176.09 0 0 0 227.42-227.42l-52.82 52.82c.31 3.38.47 6.79.47 10.25a111.94 111.94 0 0 1-112 112z"></path>
                            </svg>
              ...
              <div class="ant-row ant-form-item">
                <div class="ant-col ant-form-item-control-wrapper">
                  <div class="ant-form-item-control has-success">
                    <span class="ant-form-item-children">
                      <span class="ant-input-password ant-input-password-large ant-input-affix-wrapper ant-input-affix-wrapper-lg">
                        <input type="password" placeholder="Konfirmasi password Baru" id="inputPassword2" class="ant-input ant-input-lg" name="pass3">
                        <span class="ant-input-suffix">
                          <i aria-label="icon: eye-invisible" tabindex="-1" class="anticon anticon-eye-invisible ant-input-password-icon" id="togglePasswordVisibility2">
                            <svg viewBox="64 64 896 896" focusable="false" class="" data-icon="eye-invisible" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                              <path d="M942.2 486.2Q889.47 375.11 816.7 305l-50.88 50.88C807.31 395.53 843.45 447.4 874.7 512 791.5 684.2 673.4 766 512 766q-72.67 0-133.87-22.38L323 798.75Q408 838 512 838q288.3 0 430.2-300.3a60.29 60.29 0 0 0 0-51.5zm-63.57-320.64L836 122.88a8 8 0 0 0-11.32 0L715.31 232.2Q624.86 186 512 186q-288.3 0-430.2 300.3a60.3 60.3 0 0 0 0 51.5q56.69 119.4 136.5 191.41L112.48 835a8 8 0 0 0 0 11.31L155.17 889a8 8 0 0 0 11.31 0l712.15-712.12a8 8 0 0 0 0-11.32zM149.3 512C232.6 339.8 350.7 258 512 258c54.54 0 104.13 9.36 149.12 28.39l-70.3 70.3a176 176 0 0 0-238.13 238.13l-83.42 83.42C223.1 637.49 183.3 582.28 149.3 512zm246.7 0a112.11 112.11 0 0 1 146.2-106.69L401.31 546.2A112 112 0 0 1 396 512z"></path>
                              <path d="M508 624c-3.46 0-6.87-.16-10.25-.47l-52.82 52.82a176.09 176.09 0 0 0 227.42-227.42l-52.82 52.82c.31 3.38.47 6.79.47 10.25a111.94 111.94 0 0 1-112 112z"></path>
                            </svg>
            ...
            <div class="form-group">
                <button class="btn btn-primary"><span class="bi bi-save"></span> Simpan</button>
            </div>
        </form>
    </div>
</div>
...
<script>
                ...
                const togglePasswordVisibility1 = document.getElementById('togglePasswordVisibility1');
                let passwordVisible1 = false;

                togglePasswordVisibility1.addEventListener('click', () => {
                  passwordVisible1 = !passwordVisible1;
                  if (passwordVisible1) {
                    passwordInput1.type = 'text';
                    togglePasswordVisibility1.classList.remove('anticon-eye-invisible');
                    togglePasswordVisibility1.classList.add('anticon-eye');
                  } else {
                    passwordInput1.type = 'password';
                    togglePasswordVisibility1.classList.remove('anticon-eye');
                    togglePasswordVisibility1.classList.add('anticon-eye-invisible');
                  }
                });
</script>
<script>
                const passwordInput2 = document.getElementById('inputPassword2');
                const togglePasswordVisibility2 = document.getElementById('togglePasswordVisibility2');
                let passwordVisible2 = false;

                togglePasswordVisibility2.addEventListener('click', () => {
                  passwordVisible2 = !passwordVisible2;
                  if (passwordVisible2) {
                    passwordInput2.type = 'text';
                    togglePasswordVisibility2.classList.remove('anticon-eye-invisible');
                    togglePasswordVisibility2.classList.add('anticon-eye');
                  } else {
                    passwordInput2.type = 'password';
                    togglePasswordVisibility2.classList.remove('anticon-eye');
                    togglePasswordVisibility2.classList.add('anticon-eye-invisible');
                  }
                });
</script>